...
class PostCollectionViewController: UICollectionViewController /*UICollectionViewDelegate*/ /*UICollectionViewDataSource*/ {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell" , for: indexPath) as? PostCollectionViewCell else {
            fatalError("Failed to deque a post cell!")
        }
        
        let post = Posts[indexPath.item]
        
        cell.communityName.text = post.communityName
        cell.sharedBy.text = "Shared by + \(post.sharedBy)"
